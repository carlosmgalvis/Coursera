...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
		    ...
		    // 2. Read numToCheck characters from the file
		    String text = getStringFromFile(filename, numToCheck);
		    
		    // 3. Time the BasicDocument loop
		    ...
		    double timeBasic = (endTimeBasic - startTimeBasic) / 1_000_000_000.0;
		    
		    // 4. Print out the time for BasicDocument followed by a tab
		    System.out.print(timeBasic + "\t");
		    
		    // 5. Time the EfficientDocument loop
		    ...
		    // Calculate elapsed time in seconds
		    double timeEff = (endTimeEff - startTimeEff) / 1_000_000_000.0;
