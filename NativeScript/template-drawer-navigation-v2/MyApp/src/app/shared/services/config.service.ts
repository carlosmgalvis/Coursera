...
export class ConfigService {
  private readonly NGROK_URL_KEY = 'https://retiree-doorknob-nutcase.ngrok-free.dev';
  private readonly USERNAME_KEY = 'username';

  getNgrokUrl(): string {
    const url = applicationSettings.getString(this.NGROK_URL_KEY);
    return url || 'https://retiree-doorknob-nutcase.ngrok-free.dev'; // Default to a placeholder URL
